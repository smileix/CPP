...
class DataProcessor:
    ...
    def get_train_examples(self, data_dir: Optional[str] = None, **kwargs) -> InputExample:
        """
        ...
        if kwargs.get("mode") is not None:
            return self.get_examples(data_dir, "train", mode=kwargs.get("mode"))
        return self.get_examples(data_dir, "train")

    def get_dev_examples(self, data_dir: Optional[str] = None, **kwargs) -> List[InputExample]:
        """
        ...
        """
        if kwargs.get("mode") is not None:
            return self.get_examples(data_dir, "dev", mode=kwargs.get("mode"))
        return self.get_examples(data_dir, "dev")

    def get_test_examples(self, data_dir: Optional[str] = None, **kwargs) -> List[InputExample]:
        """
        ...
        """
        if kwargs.get("mode") is not None:
            return self.get_examples(data_dir, "test", mode=kwargs.get("mode"))
